...
var Request={
    ...
    getAllStudentRequests:function(matricula, callback){
      return db.query(" select AL.nome_aluno, S.id_solicitacao, S.data_solic, S.horas_info, S.pdf, A.nome_atividade, C.status, C.data_correcao, C.horas_aceitas,"+
      ...
      " CA.id_categoria = A.id_categoria and S.matricula = AL.matricula union select AL.nome_aluno, S.id_solicitacao, S.data_solic, S.horas_info, S.pdf, "+
    ...
    getAllRequests:function(callback){
      return db.query(" select AL.nome_aluno, AL.matricula, S.id_solicitacao, S.data_solic, S.horas_info, S.pdf, A.nome_atividade, C.status, C.data_correcao, C.horas_aceitas,"+
      ...
      " CA.id_categoria = A.id_categoria union select AL.nome_aluno, AL.matricula, S.id_solicitacao, S.data_solic, S.horas_info, S.pdf, "+
      "A.nome_atividade, null as status, null as data_correcao, null as horas_aceitas, "+
